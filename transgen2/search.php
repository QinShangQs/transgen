                    ...
                    <div class="left">
                        ...
                        <ul class="join_list">
                            <?php
                                ...
                                ?>
                                <li style="width:100%" <?php if($rscat['id']==$fl){echo " class=\"se4 bg1\"";}?>><a href="search/<?php echo $key;?>_<?php echo $rscat['id'];?>_1.html" rel="nofollow"><?php echo $rscat['catname'];?></a></li>
                                <?php }?>
                        </ul>
                    </div>
