...
switch ($action) {
    ...
    case"add";
	 ...
	 $addtime = strtotime($_POST['addtime']);
        ...
        $sql = "insert into `".$dbpre."partner` (`name`,pic,weburl,addtime) values ('$name','$pic','$weburl','$addtime')";
		if(mysql_query($sql, $conn)){
        	echo "<script>alert('添加成功');window.location.href='partner_add.php'</script>";
		}else{
