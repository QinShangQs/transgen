...
switch ($action) {
    ...
    case"edit";
	 ...
	 $name3 = trim($_POST['name3']);    //添加广州办地址  4.23
	 $khtel = trim($_POST['khtel']);
	 $jstel = trim($_POST['jstel']);
	 $content1 = trim($_POST['content1']);
	 $content2 = trim($_POST['content2']);
     $content3 = trim($_POST['content3']);    //添加广州办地址  4.23
	 
      $sql = "update `".$dbpre."contact` set name1='$name1',name2='$name2',name3='$name3',content1='$content1',content2='$content2',content3='$content3',khtel='$khtel',jstel='$jstel' where id='".$id."'";     //2014.4.23 xiugai
