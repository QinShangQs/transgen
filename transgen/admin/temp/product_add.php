...
switch ($action) {
    ...
    case"add";
     ...
     $sql = "insert into `".$dbpre."product` (cat,`name`,tedian,fanwei,baocun,sm,addtime) values ('$cat','$name','$tedian','$fanwei','$baocun','$sm','$addtime')";
	 
		if(mysql_query($sql, $conn)){
        	echo "<script>alert('添加成功');window.location.href='product_add.php'</script>";
		}else{
...
<link rel="stylesheet" href="../themes/default/default.css" />
		...
		<script>
			...
			KindEditor.ready(function(K) {
				editor = K.create('textarea[name="sm"]', {
    ...
    <form name="myform" id="myform" action="?action=add" method="post" onsubmit="return checkform(this)">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td align="left" class="bline"><input name="tedian" type="text" id="tedian" style="width:400px;" /></td>
        </tr>
        <tr>
          <td height="40" align="center" class="bline">适用范围</td>
          <td align="left" class="bline"><input name="fanwei" type="text" id="fanwei" style="width:400px;" /></td>
        </tr>
        <tr>
          <td height="40" align="center" class="bline">保存</td>
          <td align="left" class="bline"><input name="baocun" type="text" id="baocun" style="width:400px;" /></td>
        </tr>
        <tr>
          <td height="318" align="center" class="bline">产品说明</td>
          <td align="left" class="bline">
		<textarea id="sm" name="sm" cols="100" rows="8" style="width:100%;height:300px;visibility:hidden;"><?php echo htmlspecialchars($htmlData,ENT_QUOTES,'utf-8'); ?></textarea>
		<p>
        ...
        <tr>
          ...
          <td align="left">
            <input type="submit" name="Submit" value="添加产品" class="bn2" /></td>
        </tr>
      </table>
    </form>
  </DIV>
