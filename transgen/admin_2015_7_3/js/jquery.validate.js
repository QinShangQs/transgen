...
jQuery.validator.addMethod("mobile", function(value, element) {
    ...
    var mobile = /^((((13[0-9]{1})|(15[0-9]{1}))|180|187|188|189)+\d{8})$/
...
jQuery.validator.addMethod("mobilePhone", function(value, element) {
    var length = value.length;
    var mobile = /^(((((13[0-9]{1})|(15[0-9]{1}))|180|187|188|189)+\d{8})|((0[0-9]{2,3}\-)?([2-9][0-9]{6,7})+(\-[0-9]{1,4})?))$/
...
var chrnum = /^(([1-9]\d{7}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3})|([1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{4}))$/;
    return this.optional(element) || (chrnum.test(value));
}, "身份证号码错误");
