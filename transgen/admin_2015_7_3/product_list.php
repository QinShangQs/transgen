...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td align="left" class="bline">
			&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="catname" id="catname" style="width:800px;"/>  
			...
			?>					
              <tr bgcolor="#ffffff" onmouseover="this.style.background='#EEFAFF'; " onmouseout ="this.style.background='#ffffff'; this.style.bordercolor=''">
                ...
                <input type="checkbox" name="id[]" value="<?php echo $rslist['id'];?>" style="background:none; border:none;" />
                  ...
                  <td width="17%" align="center" class="bline"><a target="_blank" href="product_more_list.php?sid=<?php echo $rslist['id'];?>">查看更多规格产品</a></td>
                  <td align="center" class="bline"><a target="_blank" href="product_edit.php?id=<?php echo $rslist['id']; ?>">编辑</a></td>
              </tr>	
             <?php
			}
