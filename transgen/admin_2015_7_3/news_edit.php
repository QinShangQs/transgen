...
$sql1 = "select * from `".$dbpre."news` where id='" . $id . "'";
...
switch ($action) {
    ...
    case"edit";
	 ...
	 $addtime = strtotime($_POST['addtime']);
        ...
        $sql = "update `".$dbpre."news` set cat='$cat',name='$name',title='$title',keywords='$keywords',description='$description',content='$content',hist='$hist',addtime='$addtime' where id='".$id."'";
		if(mysql_query($sql, $conn)){
        	echo "<script>alert('修改成功');window.location.href='news_edit.php?id=".$id."'</script>";
		}else{
    ...
    <form name="myform" id="myform" action="?action=edit" method="post" onsubmit="return checkform(this)">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td align="left" class="bline"><input name="keywords" type="text" id="keywords" value="<?php echo $rs['keywords'];?>" style="width:400px;" />
仅SEO优化使用</td>
        </tr>
        <tr>
          <td height="40" align="center" class="bline">description</td>
          <td align="left" class="bline">
          <input name="description" type="text" id="description" value="<?php echo $rs['description'];?>" style="width:400px;" />
仅SEO优化使用</td>
        </tr>
        <tr>
          <td height="318" align="center" class="bline">内容</td>
          <td align="left" class="bline">
		<textarea id="content" name="content" cols="100" rows="8" style="width:100%;height:300px;visibility:hidden;"><?php echo $rs['content'];?></textarea>
		<p>
        ...
        <tr>
          ...
          <td align="left" class="bline"><input name="hist" type="text" id="hist" style="width:50px;"  value="<?php echo $rs['hist'];?>" /></td>
        </tr>
        <tr>
