                    ...
                    <div class="left widt220">
                        ...
                        <ul class="join_list">
                            <?php
                                ...
                                ?>
                                <li<?php if($cat==$rsload['id']){echo " class=\"se4 bg1\"";}?>><a href="service/<?php echo $rsload['id'];?>.html"><?php echo $rsload['catname'];?></a></li>
                                <?php
                                }
                            ?>
                            <li><a href="faq.html">产品FAQ</a></li>
                            <li><a href="video.html">视频讲座</a></li>
                        </ul>
                    </div>
                    <div class="right wid720">
                        <div class="clearfix comTitle">
                            <div class="left f18 fM"><?php echo $rscat['catname']?></div>
                            <div class="right"><a href="http://www.transgen.com.cn" rel="nofollow">首页</a> > <a href="service.html">服务与支持</a> > <span><?php echo $rscat['catname']?></span></div>
                        </div>
                        <div class="service">
                            <?php
                                $Page_size =12;
                                ...
                                <div class="serCom clearfix">
                                    <div class="left">
                                        ...
                                        <p class="mTitle"><a href="<?php echo $rslist['address'];?>"><?php echo $rslist['name'];?></a></p>
                                    </div>
                                    <?php
